...
class GuessViewModelTest {
    ...
    fun pressKeyTest(){
        ...
        assertEquals(0, model.guess.value.length)
        assertEquals(false, model.canSubmit)

        model.pressKey("A")
        assertEquals(1, model.guess.value.length)
        assertEquals(false, model.canSubmit)

        model.pressKey("B")
        assertEquals(2, model.guess.value.length)
        assertEquals(false, model.canSubmit)

        model.pressKey("C")
        assertEquals(3, model.guess.value.length)
        assertEquals(false, model.canSubmit)

        model.pressKey("D")
        assertEquals(4, model.guess.value.length)
        assertEquals(false, model.canSubmit)

        model.pressKey("E")
        assertEquals(5, model.guess.value.length)
    ...
    fun backspaceTest(){
        ...
        model.pressKey("A")
        model.pressKey("B")
        assertEquals("AB", model.guess.value)
        model.backspace()
